...
*(08-03: CI + the removed-power idea returned, but **over-broad** — v4 removed exactly ONE verb (DISMISS), it did not stop the agent being a decision-maker. The two-part tripwire argument (circularity + **n+∞ markers**) was NOT produced — re-test that specifically.)*
